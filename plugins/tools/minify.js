...
module.exports = {
    ...
    command: ["kompresjs"],
    category: 'tools',
    description: 'Mengecilkan ukuran file kode Javascript/CSS',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const res = await axios.get(`https://api.agatz.xyz/api/minify?code=${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🔍 *HASIL PENCARIAN MINIFY*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
