...
module.exports = {
    ...
    category: 'ai',
    description: 'Membuat kode pemrograman berdasarkan deskripsi',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.agatz.xyz/api/gpt4?text=Buatkan kode pemrograman lengkap dan rapi berdasarkan deskripsi berikut: ${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🤖 *CODEX AI*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
