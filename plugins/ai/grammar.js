...
module.exports = {
    ...
    category: 'ai',
    description: 'Memperbaiki tata bahasa Inggris',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.agatz.xyz/api/gpt4?text=Perbaiki tata bahasa Inggris berikut dan jelaskan singkat kesalahan nya jika ada: ${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🤖 *GRAMMAR AI*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
