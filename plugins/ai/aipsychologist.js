...
module.exports = {
    ...
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.agatz.xyz/api/gpt4?text=Bertingkahlah sebagai psikolog profesional yang ramah dan penuh empati. Berikan saran untuk curhatan berikut: ${encodeURIComponent(text)}`);
