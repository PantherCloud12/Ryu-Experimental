...
module.exports = {
    ...
    category: 'ai',
    description: 'Mencari jawaban soal sekolah di Brainly',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.agatz.xyz/api/brainly?query=${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🤖 *BRAINLY AI*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
