...
module.exports = {
    ...
    command: ["aicoding"],
    category: 'ai',
    description: 'Asisten pemrograman AI khusus',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const response = await axios.get(`https://widipe.com/gpt4?text=Bertingkahlah sebagai software engineer senior ahli. Jawab pertanyaan programming berikut: ${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🤖 *AICODER AI*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
