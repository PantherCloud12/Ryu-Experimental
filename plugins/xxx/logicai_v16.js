...
module.exports = {
    name: 'logicai V16',
    command: ["logic16","brainlyai16"],
    category: 'ai-advanced',
    description: 'AI khusus untuk menjawab soal logika/sekolah (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan logicai V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari logicai V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
