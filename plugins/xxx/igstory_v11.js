...
module.exports = {
    ...
    description: 'Download story Instagram via username (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan igstory V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari igstory V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
