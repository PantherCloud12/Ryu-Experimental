...
module.exports = {
    name: 'khodam V7',
    command: ["khodam7","cekkhodam7"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
