...
module.exports = {
    name: 'videoenhance V22',
    command: ["venhance22","ve22"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V22)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V22' }, { quoted: m });
        } catch (e) {
