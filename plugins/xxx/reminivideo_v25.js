...
module.exports = {
    name: 'reminivideo V25',
    command: ["reminivid25","rvid25"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V25' }, { quoted: m });
        } catch (e) {
