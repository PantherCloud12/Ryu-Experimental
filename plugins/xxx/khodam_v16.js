...
module.exports = {
    name: 'khodam V16',
    command: ["khodam16","cekkhodam16"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
