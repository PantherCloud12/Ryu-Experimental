...
module.exports = {
    name: 'remini V3',
    command: ["remini3","hd3","upscale3"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
