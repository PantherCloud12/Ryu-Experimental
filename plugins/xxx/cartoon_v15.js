...
module.exports = {
    name: 'cartoon V15',
    command: ["cartoon15","jadianime15"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
