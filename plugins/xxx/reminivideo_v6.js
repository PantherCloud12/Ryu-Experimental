...
module.exports = {
    name: 'reminivideo V6',
    command: ["reminivid6","rvid6"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V6' }, { quoted: m });
        } catch (e) {
