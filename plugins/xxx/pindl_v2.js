...
module.exports = {
    name: 'pindl V2',
    command: ["pindl2","pinterestdl2"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
