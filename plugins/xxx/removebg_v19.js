...
module.exports = {
    name: 'removebg V19',
    command: ["removebg19","nobg19"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
