...
module.exports = {
    name: 'ttmusic V22',
    command: ["ttmusic22","ttoaudio22"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
