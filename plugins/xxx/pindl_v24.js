...
module.exports = {
    name: 'pindl V24',
    command: ["pindl24","pinterestdl24"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
