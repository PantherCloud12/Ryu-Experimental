...
module.exports = {
    name: 'hdvideo V9',
    command: ["hdvid9","hdvideo9","vt9"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V9' }, { quoted: m });
        } catch (e) {
