...
module.exports = {
    ...
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
