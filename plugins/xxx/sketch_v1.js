...
module.exports = {
    name: 'sketch V1',
    command: ["sketch","sketsa"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
