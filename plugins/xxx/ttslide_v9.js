...
module.exports = {
    name: 'ttslide V9',
    command: ["ttslide9","tiktokslide9"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
