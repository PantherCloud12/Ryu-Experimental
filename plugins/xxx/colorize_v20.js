...
module.exports = {
    name: 'colorize V20',
    command: ["colorize20","warnai20"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
