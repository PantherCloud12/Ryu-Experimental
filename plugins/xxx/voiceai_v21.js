...
module.exports = {
    name: 'voiceai V21',
    command: ["voiceai21","tts-ai21"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
