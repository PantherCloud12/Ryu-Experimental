...
module.exports = {
    name: 'hdvideo V19',
    command: ["hdvid19","hdvideo19","vt19"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V19' }, { quoted: m });
        } catch (e) {
