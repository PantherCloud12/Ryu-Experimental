...
module.exports = {
    ...
    command: ["enhance7"],
    category: 'hd-tools',
    description: 'Auto enhance kualitas gambar (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan enhance V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari enhance V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
