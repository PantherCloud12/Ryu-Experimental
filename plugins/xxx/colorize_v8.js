...
module.exports = {
    name: 'colorize V8',
    command: ["colorize8","warnai8"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
