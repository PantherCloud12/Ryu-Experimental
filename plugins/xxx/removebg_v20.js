...
module.exports = {
    name: 'removebg V20',
    command: ["removebg20","nobg20"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
