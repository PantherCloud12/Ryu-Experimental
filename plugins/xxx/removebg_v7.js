...
module.exports = {
    name: 'removebg V7',
    command: ["removebg7","nobg7"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
