...
module.exports = {
    name: 'videoenhance V20',
    command: ["venhance20","ve20"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V20)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V20' }, { quoted: m });
        } catch (e) {
