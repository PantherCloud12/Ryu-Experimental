...
module.exports = {
    name: 'hdvideo V7',
    command: ["hdvid7","hdvideo7","vt7"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V7' }, { quoted: m });
        } catch (e) {
