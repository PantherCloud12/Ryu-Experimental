...
module.exports = {
    name: 'reminivideo V28',
    command: ["reminivid28","rvid28"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V28' }, { quoted: m });
        } catch (e) {
