...
module.exports = {
    name: 'gdrivedl V26',
    command: ["gdrive26","gd26"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
