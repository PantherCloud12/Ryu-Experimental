...
module.exports = {
    name: 'remini V14',
    command: ["remini14","hd14","upscale14"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
