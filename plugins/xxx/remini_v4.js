...
module.exports = {
    name: 'remini V4',
    command: ["remini4","hd4","upscale4"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
