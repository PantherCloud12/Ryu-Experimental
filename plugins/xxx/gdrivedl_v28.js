...
module.exports = {
    name: 'gdrivedl V28',
    command: ["gdrive28","gd28"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
