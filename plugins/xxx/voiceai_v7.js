...
module.exports = {
    name: 'voiceai V7',
    command: ["voiceai7","tts-ai7"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
