...
module.exports = {
    name: 'logicai V14',
    command: ["logic14","brainlyai14"],
    category: 'ai-advanced',
    description: 'AI khusus untuk menjawab soal logika/sekolah (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan logicai V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari logicai V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
