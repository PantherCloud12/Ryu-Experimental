...
module.exports = {
    name: 'colorize V10',
    command: ["colorize10","warnai10"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
