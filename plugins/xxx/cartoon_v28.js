...
module.exports = {
    name: 'cartoon V28',
    command: ["cartoon28","jadianime28"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
