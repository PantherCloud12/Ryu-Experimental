...
module.exports = {
    name: 'blur V23',
    command: ["blur23","bokeh23"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
