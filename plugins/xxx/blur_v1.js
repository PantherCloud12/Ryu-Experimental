...
module.exports = {
    ...
    command: ["blur","bokeh"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
