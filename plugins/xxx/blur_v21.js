...
module.exports = {
    name: 'blur V21',
    command: ["blur21","bokeh21"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
