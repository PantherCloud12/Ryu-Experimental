...
module.exports = {
    name: 'removebg V3',
    command: ["removebg3","nobg3"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
