...
module.exports = {
    name: 'pindl V7',
    command: ["pindl7","pinterestdl7"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
