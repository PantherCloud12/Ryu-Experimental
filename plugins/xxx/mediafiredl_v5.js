...
module.exports = {
    name: 'mediafiredl V5',
    command: ["mf5","mediafire5"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
