...
module.exports = {
    name: 'remini V5',
    command: ["remini5","hd5","upscale5"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
