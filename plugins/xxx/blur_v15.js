...
module.exports = {
    name: 'blur V15',
    command: ["blur15","bokeh15"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
