...
module.exports = {
    name: 'khodam V2',
    command: ["khodam2","cekkhodam2"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
