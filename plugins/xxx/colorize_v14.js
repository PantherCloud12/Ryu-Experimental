...
module.exports = {
    name: 'colorize V14',
    command: ["colorize14","warnai14"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
