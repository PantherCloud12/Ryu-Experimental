...
module.exports = {
    name: 'sketch V13',
    command: ["sketch13","sketsa13"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
