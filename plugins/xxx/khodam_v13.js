...
module.exports = {
    name: 'khodam V13',
    command: ["khodam13","cekkhodam13"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
