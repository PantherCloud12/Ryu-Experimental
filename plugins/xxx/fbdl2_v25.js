...
module.exports = {
    name: 'fbdl2 V25',
    command: ["fbdl225","fbhd25"],
    category: 'downloader-pro',
    description: 'Facebook video downloader kualitas HD (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan fbdl2 V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari fbdl2 V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
