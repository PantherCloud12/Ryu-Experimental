...
module.exports = {
    name: 'hdvideo V8',
    command: ["hdvid8","hdvideo8","vt8"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V8' }, { quoted: m });
        } catch (e) {
