...
module.exports = {
    name: 'gdrivedl V17',
    command: ["gdrive17","gd17"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
