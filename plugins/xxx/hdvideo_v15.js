...
module.exports = {
    name: 'hdvideo V15',
    command: ["hdvid15","hdvideo15","vt15"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V15' }, { quoted: m });
        } catch (e) {
