...
module.exports = {
    name: 'gdrivedl V25',
    command: ["gdrive25","gd25"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
