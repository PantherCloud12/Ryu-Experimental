...
module.exports = {
    name: 'mediafiredl V4',
    command: ["mf4","mediafire4"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
