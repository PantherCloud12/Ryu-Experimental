...
module.exports = {
    name: 'hdvideo V25',
    command: ["hdvid25","hdvideo25","vt25"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V25' }, { quoted: m });
        } catch (e) {
