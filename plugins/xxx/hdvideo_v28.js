...
module.exports = {
    name: 'hdvideo V28',
    command: ["hdvid28","hdvideo28","vt28"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V28' }, { quoted: m });
        } catch (e) {
