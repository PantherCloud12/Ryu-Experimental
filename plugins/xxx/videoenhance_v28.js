...
module.exports = {
    name: 'videoenhance V28',
    command: ["venhance28","ve28"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V28)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V28' }, { quoted: m });
        } catch (e) {
