...
module.exports = {
    name: 'jodoh V16',
    command: ["jodoh16","cekjodoh16"],
    category: 'fun-viral',
    description: 'Cek kecocokan jodoh berdasarkan nama (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan jodoh V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari jodoh V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
