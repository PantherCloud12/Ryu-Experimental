...
module.exports = {
    name: 'khodam V11',
    command: ["khodam11","cekkhodam11"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
