...
module.exports = {
    ...
    command: ["dehaze6"],
    category: 'hd-tools',
    description: 'Menghilangkan kabut/asap pada foto (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan dehaze V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari dehaze V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
