...
module.exports = {
    name: 'voiceai V23',
    command: ["voiceai23","tts-ai23"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
