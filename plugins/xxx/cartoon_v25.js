...
module.exports = {
    name: 'cartoon V25',
    command: ["cartoon25","jadianime25"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
