...
module.exports = {
    name: 'sketch V12',
    command: ["sketch12","sketsa12"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
