...
module.exports = {
    name: 'colorize V18',
    command: ["colorize18","warnai18"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
