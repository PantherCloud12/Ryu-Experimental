...
module.exports = {
    name: 'removebg V29',
    command: ["removebg29","nobg29"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
