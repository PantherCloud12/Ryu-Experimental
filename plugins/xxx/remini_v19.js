...
module.exports = {
    name: 'remini V19',
    command: ["remini19","hd19","upscale19"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
