...
module.exports = {
    name: 'colorize V30',
    command: ["colorize30","warnai30"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
