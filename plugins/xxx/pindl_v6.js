...
module.exports = {
    name: 'pindl V6',
    command: ["pindl6","pinterestdl6"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
