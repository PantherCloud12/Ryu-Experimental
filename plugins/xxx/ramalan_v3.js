...
module.exports = {
    ...
    command: ["ramalan3"],
    category: 'fun-viral',
    description: 'Ramalan harian berdasarkan zodiak/nama (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ramalan V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ramalan V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
