...
module.exports = {
    name: 'mediafiredl V9',
    command: ["mf9","mediafire9"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
