...
module.exports = {
    name: 'blur V29',
    command: ["blur29","bokeh29"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
