...
module.exports = {
    name: 'videoenhance V30',
    command: ["venhance30","ve30"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V30)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V30' }, { quoted: m });
        } catch (e) {
