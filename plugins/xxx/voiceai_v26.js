...
module.exports = {
    name: 'voiceai V26',
    command: ["voiceai26","tts-ai26"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
