...
module.exports = {
    name: 'cartoon V23',
    command: ["cartoon23","jadianime23"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
