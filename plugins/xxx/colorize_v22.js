...
module.exports = {
    name: 'colorize V22',
    command: ["colorize22","warnai22"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
