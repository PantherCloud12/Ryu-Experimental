...
module.exports = {
    name: 'ttmusic V18',
    command: ["ttmusic18","ttoaudio18"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
