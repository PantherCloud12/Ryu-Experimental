...
module.exports = {
    name: 'remini V26',
    command: ["remini26","hd26","upscale26"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
