...
module.exports = {
    name: 'voiceai V29',
    command: ["voiceai29","tts-ai29"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
