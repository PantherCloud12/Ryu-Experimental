...
module.exports = {
    ...
    command: ["dehaze22"],
    category: 'hd-tools',
    description: 'Menghilangkan kabut/asap pada foto (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan dehaze V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari dehaze V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
