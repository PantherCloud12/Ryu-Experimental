...
module.exports = {
    name: 'colorize V6',
    command: ["colorize6","warnai6"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
