...
module.exports = {
    name: 'remini V10',
    command: ["remini10","hd10","upscale10"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
