...
module.exports = {
    name: 'sketch V17',
    command: ["sketch17","sketsa17"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
