...
module.exports = {
    ...
    command: ["ramalan27"],
    category: 'fun-viral',
    description: 'Ramalan harian berdasarkan zodiak/nama (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ramalan V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ramalan V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
