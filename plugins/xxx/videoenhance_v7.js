...
module.exports = {
    name: 'videoenhance V7',
    command: ["venhance7","ve7"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V7)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V7' }, { quoted: m });
        } catch (e) {
