...
module.exports = {
    name: 'cartoon V26',
    command: ["cartoon26","jadianime26"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
