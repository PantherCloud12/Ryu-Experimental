...
module.exports = {
    name: 'sketch V27',
    command: ["sketch27","sketsa27"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
