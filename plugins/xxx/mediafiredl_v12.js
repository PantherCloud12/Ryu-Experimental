...
module.exports = {
    name: 'mediafiredl V12',
    command: ["mf12","mediafire12"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
