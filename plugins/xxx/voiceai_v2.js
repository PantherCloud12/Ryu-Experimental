...
module.exports = {
    name: 'voiceai V2',
    command: ["voiceai2","tts-ai2"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
