...
module.exports = {
    name: 'videoenhance V9',
    command: ["venhance9","ve9"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V9)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V9' }, { quoted: m });
        } catch (e) {
