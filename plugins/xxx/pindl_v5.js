...
module.exports = {
    name: 'pindl V5',
    command: ["pindl5","pinterestdl5"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
