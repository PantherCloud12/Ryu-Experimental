...
module.exports = {
    name: 'mediafiredl V18',
    command: ["mf18","mediafire18"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
