...
module.exports = {
    name: 'jodoh V14',
    command: ["jodoh14","cekjodoh14"],
    category: 'fun-viral',
    description: 'Cek kecocokan jodoh berdasarkan nama (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan jodoh V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari jodoh V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
