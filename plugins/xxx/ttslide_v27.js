...
module.exports = {
    name: 'ttslide V27',
    command: ["ttslide27","tiktokslide27"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
