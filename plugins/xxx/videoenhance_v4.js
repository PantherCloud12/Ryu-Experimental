...
module.exports = {
    name: 'videoenhance V4',
    command: ["venhance4","ve4"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V4)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V4' }, { quoted: m });
        } catch (e) {
