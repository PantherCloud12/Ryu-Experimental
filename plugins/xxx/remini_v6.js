...
module.exports = {
    name: 'remini V6',
    command: ["remini6","hd6","upscale6"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
