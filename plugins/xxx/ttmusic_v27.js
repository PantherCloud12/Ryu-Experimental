...
module.exports = {
    name: 'ttmusic V27',
    command: ["ttmusic27","ttoaudio27"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
