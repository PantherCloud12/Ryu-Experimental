...
module.exports = {
    name: 'sketch V3',
    command: ["sketch3","sketsa3"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
