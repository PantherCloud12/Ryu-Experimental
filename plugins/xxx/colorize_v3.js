...
module.exports = {
    name: 'colorize V3',
    command: ["colorize3","warnai3"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
