...
module.exports = {
    name: 'gdrivedl V29',
    command: ["gdrive29","gd29"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
