...
module.exports = {
    name: 'cartoon V11',
    command: ["cartoon11","jadianime11"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
