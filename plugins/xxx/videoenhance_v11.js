...
module.exports = {
    name: 'videoenhance V11',
    command: ["venhance11","ve11"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V11)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V11' }, { quoted: m });
        } catch (e) {
