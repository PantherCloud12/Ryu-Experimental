...
module.exports = {
    name: 'reminivideo V14',
    command: ["reminivid14","rvid14"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V14' }, { quoted: m });
        } catch (e) {
