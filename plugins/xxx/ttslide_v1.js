...
module.exports = {
    name: 'ttslide V1',
    command: ["ttslide","tiktokslide"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
