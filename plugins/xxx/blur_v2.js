...
module.exports = {
    name: 'blur V2',
    command: ["blur2","bokeh2"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
