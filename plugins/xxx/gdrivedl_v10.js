...
module.exports = {
    name: 'gdrivedl V10',
    command: ["gdrive10","gd10"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
