...
module.exports = {
    name: 'colorize V23',
    command: ["colorize23","warnai23"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
