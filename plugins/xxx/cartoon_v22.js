...
module.exports = {
    name: 'cartoon V22',
    command: ["cartoon22","jadianime22"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
