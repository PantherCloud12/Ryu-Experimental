...
module.exports = {
    name: 'colorize V13',
    command: ["colorize13","warnai13"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
