...
module.exports = {
    name: 'remini V25',
    command: ["remini25","hd25","upscale25"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
