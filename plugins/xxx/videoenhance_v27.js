...
module.exports = {
    name: 'videoenhance V27',
    command: ["venhance27","ve27"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V27' }, { quoted: m });
        } catch (e) {
