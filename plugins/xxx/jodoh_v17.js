...
module.exports = {
    name: 'jodoh V17',
    command: ["jodoh17","cekjodoh17"],
    category: 'fun-viral',
    description: 'Cek kecocokan jodoh berdasarkan nama (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan jodoh V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari jodoh V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
