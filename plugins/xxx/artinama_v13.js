...
module.exports = {
    ...
    command: ["artinama13"],
    category: 'fun-viral',
    description: 'Mencari arti dari sebuah nama (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan artinama V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari artinama V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
