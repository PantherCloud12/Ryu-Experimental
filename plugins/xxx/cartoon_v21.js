...
module.exports = {
    name: 'cartoon V21',
    command: ["cartoon21","jadianime21"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
