...
module.exports = {
    name: 'reminivideo V5',
    command: ["reminivid5","rvid5"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V5' }, { quoted: m });
        } catch (e) {
