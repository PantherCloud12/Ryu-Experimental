...
module.exports = {
    name: 'pindl V29',
    command: ["pindl29","pinterestdl29"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
