...
module.exports = {
    name: 'voiceai V8',
    command: ["voiceai8","tts-ai8"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
