...
module.exports = {
    name: 'khodam V18',
    command: ["khodam18","cekkhodam18"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
