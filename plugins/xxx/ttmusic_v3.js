...
module.exports = {
    name: 'ttmusic V3',
    command: ["ttmusic3","ttoaudio3"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
