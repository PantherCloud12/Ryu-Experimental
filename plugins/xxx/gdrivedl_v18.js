...
module.exports = {
    name: 'gdrivedl V18',
    command: ["gdrive18","gd18"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
