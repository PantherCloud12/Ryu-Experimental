...
module.exports = {
    name: 'blur V26',
    command: ["blur26","bokeh26"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
