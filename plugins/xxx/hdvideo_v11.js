...
module.exports = {
    name: 'hdvideo V11',
    command: ["hdvid11","hdvideo11","vt11"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V11' }, { quoted: m });
        } catch (e) {
