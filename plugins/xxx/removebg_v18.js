...
module.exports = {
    name: 'removebg V18',
    command: ["removebg18","nobg18"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
