...
module.exports = {
    name: 'voiceai V14',
    command: ["voiceai14","tts-ai14"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
