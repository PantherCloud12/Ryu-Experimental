...
module.exports = {
    name: 'removebg V8',
    command: ["removebg8","nobg8"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
