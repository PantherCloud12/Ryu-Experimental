...
module.exports = {
    name: 'reminivideo V17',
    command: ["reminivid17","rvid17"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V17' }, { quoted: m });
        } catch (e) {
