...
module.exports = {
    ...
    command: ["artinama8"],
    category: 'fun-viral',
    description: 'Mencari arti dari sebuah nama (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan artinama V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari artinama V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
