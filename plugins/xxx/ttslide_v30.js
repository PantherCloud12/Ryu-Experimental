...
module.exports = {
    name: 'ttslide V30',
    command: ["ttslide30","tiktokslide30"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
