...
module.exports = {
    name: 'mediafiredl V25',
    command: ["mf25","mediafire25"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
