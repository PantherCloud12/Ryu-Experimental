...
module.exports = {
    name: 'ttmusic V14',
    command: ["ttmusic14","ttoaudio14"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
