...
module.exports = {
    name: 'reminivideo V27',
    command: ["reminivid27","rvid27"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V27' }, { quoted: m });
        } catch (e) {
