...
module.exports = {
    name: 'ttslide V7',
    command: ["ttslide7","tiktokslide7"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
