...
module.exports = {
    name: 'cartoon V14',
    command: ["cartoon14","jadianime14"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
