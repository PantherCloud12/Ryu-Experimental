...
module.exports = {
    ...
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
