...
module.exports = {
    name: 'sketch V4',
    command: ["sketch4","sketsa4"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
