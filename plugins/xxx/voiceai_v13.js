...
module.exports = {
    name: 'voiceai V13',
    command: ["voiceai13","tts-ai13"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
