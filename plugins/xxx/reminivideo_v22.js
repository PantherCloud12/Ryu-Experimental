...
module.exports = {
    name: 'reminivideo V22',
    command: ["reminivid22","rvid22"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V22' }, { quoted: m });
        } catch (e) {
