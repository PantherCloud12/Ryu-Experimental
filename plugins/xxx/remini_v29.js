...
module.exports = {
    name: 'remini V29',
    command: ["remini29","hd29","upscale29"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
