...
module.exports = {
    name: 'ttmusic V9',
    command: ["ttmusic9","ttoaudio9"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
