...
module.exports = {
    name: 'voiceai V10',
    command: ["voiceai10","tts-ai10"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
