...
module.exports = {
    name: 'blur V3',
    command: ["blur3","bokeh3"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
