...
module.exports = {
    name: 'sketch V26',
    command: ["sketch26","sketsa26"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
