...
module.exports = {
    name: 'reminivideo V11',
    command: ["reminivid11","rvid11"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V11' }, { quoted: m });
        } catch (e) {
