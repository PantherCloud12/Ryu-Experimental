...
module.exports = {
    name: 'voiceai V19',
    command: ["voiceai19","tts-ai19"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
