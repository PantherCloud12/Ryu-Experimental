...
module.exports = {
    name: 'pindl V19',
    command: ["pindl19","pinterestdl19"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
