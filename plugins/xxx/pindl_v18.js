...
module.exports = {
    name: 'pindl V18',
    command: ["pindl18","pinterestdl18"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
