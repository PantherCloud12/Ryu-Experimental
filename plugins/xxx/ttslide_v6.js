...
module.exports = {
    name: 'ttslide V6',
    command: ["ttslide6","tiktokslide6"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
