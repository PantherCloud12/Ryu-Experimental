...
module.exports = {
    name: 'reminivideo V20',
    command: ["reminivid20","rvid20"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V20' }, { quoted: m });
        } catch (e) {
