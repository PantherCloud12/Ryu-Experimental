...
module.exports = {
    name: 'voiceai V24',
    command: ["voiceai24","tts-ai24"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
