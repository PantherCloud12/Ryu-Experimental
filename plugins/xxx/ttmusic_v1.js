...
module.exports = {
    name: 'ttmusic V1',
    command: ["ttmusic","ttoaudio"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
