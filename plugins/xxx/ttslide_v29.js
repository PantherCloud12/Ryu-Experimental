...
module.exports = {
    name: 'ttslide V29',
    command: ["ttslide29","tiktokslide29"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
