...
module.exports = {
    name: 'remini V12',
    command: ["remini12","hd12","upscale12"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
