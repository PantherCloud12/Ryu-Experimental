...
module.exports = {
    name: 'videoenhance V15',
    command: ["venhance15","ve15"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V15)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V15' }, { quoted: m });
        } catch (e) {
