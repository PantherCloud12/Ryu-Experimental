...
module.exports = {
    name: 'khodam V30',
    command: ["khodam30","cekkhodam30"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
