...
module.exports = {
    name: 'mediafiredl V28',
    command: ["mf28","mediafire28"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
