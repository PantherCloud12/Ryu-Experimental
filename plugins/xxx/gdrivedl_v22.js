...
module.exports = {
    name: 'gdrivedl V22',
    command: ["gdrive22","gd22"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
