...
module.exports = {
    name: 'gdrivedl V16',
    command: ["gdrive16","gd16"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
