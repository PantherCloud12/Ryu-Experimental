...
module.exports = {
    name: 'mediafiredl V19',
    command: ["mf19","mediafire19"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
