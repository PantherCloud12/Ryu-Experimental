...
module.exports = {
    name: 'colorize V24',
    command: ["colorize24","warnai24"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
