...
module.exports = {
    name: 'hdvideo V4',
    command: ["hdvid4","hdvideo4","vt4"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V4' }, { quoted: m });
        } catch (e) {
