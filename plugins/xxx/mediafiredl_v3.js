...
module.exports = {
    name: 'mediafiredl V3',
    command: ["mf3","mediafire3"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
