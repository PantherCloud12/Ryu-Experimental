...
module.exports = {
    name: 'fbdl2 V4',
    command: ["fbdl24","fbhd4"],
    category: 'downloader-pro',
    description: 'Facebook video downloader kualitas HD (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan fbdl2 V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari fbdl2 V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
