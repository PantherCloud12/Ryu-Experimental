...
module.exports = {
    name: 'hdvideo V5',
    command: ["hdvid5","hdvideo5","vt5"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V5' }, { quoted: m });
        } catch (e) {
