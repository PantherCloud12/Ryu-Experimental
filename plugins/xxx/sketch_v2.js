...
module.exports = {
    name: 'sketch V2',
    command: ["sketch2","sketsa2"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
