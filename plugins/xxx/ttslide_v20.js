...
module.exports = {
    name: 'ttslide V20',
    command: ["ttslide20","tiktokslide20"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
