...
module.exports = {
    name: 'ttmusic V6',
    command: ["ttmusic6","ttoaudio6"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
