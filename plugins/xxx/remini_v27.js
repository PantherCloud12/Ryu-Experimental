...
module.exports = {
    name: 'remini V27',
    command: ["remini27","hd27","upscale27"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
