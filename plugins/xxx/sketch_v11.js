...
module.exports = {
    name: 'sketch V11',
    command: ["sketch11","sketsa11"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
