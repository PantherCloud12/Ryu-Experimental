...
module.exports = {
    name: 'videoenhance V2',
    command: ["venhance2","ve2"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V2)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V2' }, { quoted: m });
        } catch (e) {
