...
module.exports = {
    name: 'voiceai V3',
    command: ["voiceai3","tts-ai3"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
