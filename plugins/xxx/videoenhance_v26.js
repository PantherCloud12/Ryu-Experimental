...
module.exports = {
    name: 'videoenhance V26',
    command: ["venhance26","ve26"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V26)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V26' }, { quoted: m });
        } catch (e) {
