...
module.exports = {
    name: 'sketch V16',
    command: ["sketch16","sketsa16"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
