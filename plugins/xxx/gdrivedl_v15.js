...
module.exports = {
    name: 'gdrivedl V15',
    command: ["gdrive15","gd15"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
