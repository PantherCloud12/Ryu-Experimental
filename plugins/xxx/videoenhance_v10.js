...
module.exports = {
    name: 'videoenhance V10',
    command: ["venhance10","ve10"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V10' }, { quoted: m });
        } catch (e) {
