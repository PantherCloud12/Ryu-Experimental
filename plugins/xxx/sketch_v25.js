...
module.exports = {
    name: 'sketch V25',
    command: ["sketch25","sketsa25"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
