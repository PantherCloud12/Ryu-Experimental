...
module.exports = {
    name: 'khodam V21',
    command: ["khodam21","cekkhodam21"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
