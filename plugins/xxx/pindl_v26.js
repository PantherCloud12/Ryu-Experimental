...
module.exports = {
    name: 'pindl V26',
    command: ["pindl26","pinterestdl26"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
