...
module.exports = {
    name: 'ttslide V22',
    command: ["ttslide22","tiktokslide22"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
