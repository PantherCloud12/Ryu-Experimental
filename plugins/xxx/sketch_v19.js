...
module.exports = {
    name: 'sketch V19',
    command: ["sketch19","sketsa19"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
