...
module.exports = {
    name: 'colorize V17',
    command: ["colorize17","warnai17"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
