...
module.exports = {
    name: 'hdvideo V23',
    command: ["hdvid23","hdvideo23","vt23"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V23' }, { quoted: m });
        } catch (e) {
