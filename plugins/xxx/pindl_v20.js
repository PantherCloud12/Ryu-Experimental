...
module.exports = {
    name: 'pindl V20',
    command: ["pindl20","pinterestdl20"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
