...
module.exports = {
    name: 'colorize V25',
    command: ["colorize25","warnai25"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
