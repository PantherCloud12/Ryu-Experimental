...
module.exports = {
    ...
    command: ["enhance5"],
    category: 'hd-tools',
    description: 'Auto enhance kualitas gambar (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan enhance V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari enhance V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
