...
module.exports = {
    name: 'colorize V2',
    command: ["colorize2","warnai2"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
