...
module.exports = {
    name: 'reminivideo V29',
    command: ["reminivid29","rvid29"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V29' }, { quoted: m });
        } catch (e) {
