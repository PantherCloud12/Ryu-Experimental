...
module.exports = {
    name: 'colorize V16',
    command: ["colorize16","warnai16"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
