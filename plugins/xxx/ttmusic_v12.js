...
module.exports = {
    name: 'ttmusic V12',
    command: ["ttmusic12","ttoaudio12"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
