...
module.exports = {
    name: 'khodam V20',
    command: ["khodam20","cekkhodam20"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
