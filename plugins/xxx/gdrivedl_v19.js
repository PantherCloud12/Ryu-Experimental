...
module.exports = {
    name: 'gdrivedl V19',
    command: ["gdrive19","gd19"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
