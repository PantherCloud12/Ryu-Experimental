...
module.exports = {
    name: 'videoenhance V3',
    command: ["venhance3","ve3"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V3)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V3' }, { quoted: m });
        } catch (e) {
