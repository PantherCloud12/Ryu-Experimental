...
module.exports = {
    ...
    description: 'Download video YouTube kualitas tinggi (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ytdl-mp4 V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ytdl-mp4 V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
