...
module.exports = {
    name: 'pindl V28',
    command: ["pindl28","pinterestdl28"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
