...
module.exports = {
    name: 'removebg V23',
    command: ["removebg23","nobg23"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
