...
module.exports = {
    ...
    command: ["artinama9"],
    category: 'fun-viral',
    description: 'Mencari arti dari sebuah nama (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan artinama V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari artinama V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
