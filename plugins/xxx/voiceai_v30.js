...
module.exports = {
    name: 'voiceai V30',
    command: ["voiceai30","tts-ai30"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
