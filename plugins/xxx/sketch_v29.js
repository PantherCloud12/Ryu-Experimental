...
module.exports = {
    name: 'sketch V29',
    command: ["sketch29","sketsa29"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
