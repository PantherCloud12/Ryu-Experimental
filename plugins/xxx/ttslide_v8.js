...
module.exports = {
    name: 'ttslide V8',
    command: ["ttslide8","tiktokslide8"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
