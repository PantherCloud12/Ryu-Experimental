...
module.exports = {
    name: 'remini V13',
    command: ["remini13","hd13","upscale13"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
