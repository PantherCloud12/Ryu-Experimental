...
module.exports = {
    name: 'videoenhance V29',
    command: ["venhance29","ve29"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V29)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V29' }, { quoted: m });
        } catch (e) {
