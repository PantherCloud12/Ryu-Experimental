...
module.exports = {
    ...
    description: 'Download story Instagram via username (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan igstory V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari igstory V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
