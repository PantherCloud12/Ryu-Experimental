...
module.exports = {
    name: 'videoenhance V24',
    command: ["venhance24","ve24"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V24)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V24' }, { quoted: m });
        } catch (e) {
