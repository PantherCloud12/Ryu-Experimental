...
module.exports = {
    name: 'reminivideo V2',
    command: ["reminivid2","rvid2"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V2' }, { quoted: m });
        } catch (e) {
