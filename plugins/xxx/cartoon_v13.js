...
module.exports = {
    name: 'cartoon V13',
    command: ["cartoon13","jadianime13"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
