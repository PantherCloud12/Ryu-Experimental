...
module.exports = {
    name: 'removebg V28',
    command: ["removebg28","nobg28"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
