...
module.exports = {
    name: 'mediafiredl V2',
    command: ["mf2","mediafire2"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
