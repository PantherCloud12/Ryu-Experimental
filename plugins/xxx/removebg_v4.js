...
module.exports = {
    name: 'removebg V4',
    command: ["removebg4","nobg4"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
