...
module.exports = {
    name: 'colorize V4',
    command: ["colorize4","warnai4"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
