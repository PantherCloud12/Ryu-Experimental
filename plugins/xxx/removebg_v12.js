...
module.exports = {
    name: 'removebg V12',
    command: ["removebg12","nobg12"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
