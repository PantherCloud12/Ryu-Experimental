...
module.exports = {
    name: 'pindl V16',
    command: ["pindl16","pinterestdl16"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
