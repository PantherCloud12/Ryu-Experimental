...
module.exports = {
    name: 'blur V17',
    command: ["blur17","bokeh17"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
