...
module.exports = {
    name: 'colorize V5',
    command: ["colorize5","warnai5"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
