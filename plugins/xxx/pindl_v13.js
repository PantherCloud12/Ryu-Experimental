...
module.exports = {
    name: 'pindl V13',
    command: ["pindl13","pinterestdl13"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
