...
module.exports = {
    name: 'mediafiredl V27',
    command: ["mf27","mediafire27"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
