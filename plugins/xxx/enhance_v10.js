...
module.exports = {
    ...
    command: ["enhance10"],
    category: 'hd-tools',
    description: 'Auto enhance kualitas gambar (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan enhance V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari enhance V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
