...
module.exports = {
    name: 'videoenhance V14',
    command: ["venhance14","ve14"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V14)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V14' }, { quoted: m });
        } catch (e) {
