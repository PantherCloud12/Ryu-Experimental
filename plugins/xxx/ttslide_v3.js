...
module.exports = {
    name: 'ttslide V3',
    command: ["ttslide3","tiktokslide3"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
