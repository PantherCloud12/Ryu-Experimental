...
module.exports = {
    name: 'voiceai V5',
    command: ["voiceai5","tts-ai5"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
