...
module.exports = {
    name: 'mediafiredl V14',
    command: ["mf14","mediafire14"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
