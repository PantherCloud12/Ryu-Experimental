...
module.exports = {
    name: 'blur V7',
    command: ["blur7","bokeh7"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
