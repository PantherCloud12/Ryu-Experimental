...
module.exports = {
    name: 'sketch V7',
    command: ["sketch7","sketsa7"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
