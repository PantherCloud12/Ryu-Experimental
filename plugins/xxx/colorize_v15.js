...
module.exports = {
    name: 'colorize V15',
    command: ["colorize15","warnai15"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
