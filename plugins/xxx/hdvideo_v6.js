...
module.exports = {
    name: 'hdvideo V6',
    command: ["hdvid6","hdvideo6","vt6"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V6' }, { quoted: m });
        } catch (e) {
