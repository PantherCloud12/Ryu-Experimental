...
module.exports = {
    name: 'colorize V11',
    command: ["colorize11","warnai11"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
