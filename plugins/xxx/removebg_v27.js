...
module.exports = {
    name: 'removebg V27',
    command: ["removebg27","nobg27"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
