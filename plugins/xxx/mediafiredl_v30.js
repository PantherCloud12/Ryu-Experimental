...
module.exports = {
    name: 'mediafiredl V30',
    command: ["mf30","mediafire30"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
