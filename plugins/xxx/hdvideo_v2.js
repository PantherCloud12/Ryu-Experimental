...
module.exports = {
    name: 'hdvideo V2',
    command: ["hdvid2","hdvideo2","vt2"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V2' }, { quoted: m });
        } catch (e) {
