...
module.exports = {
    name: 'removebg V24',
    command: ["removebg24","nobg24"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
