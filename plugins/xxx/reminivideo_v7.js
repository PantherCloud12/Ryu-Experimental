...
module.exports = {
    name: 'reminivideo V7',
    command: ["reminivid7","rvid7"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V7' }, { quoted: m });
        } catch (e) {
