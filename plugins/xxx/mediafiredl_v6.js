...
module.exports = {
    name: 'mediafiredl V6',
    command: ["mf6","mediafire6"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
