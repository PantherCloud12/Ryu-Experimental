...
module.exports = {
    name: 'gdrivedl V30',
    command: ["gdrive30","gd30"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
