...
module.exports = {
    name: 'pindl V3',
    command: ["pindl3","pinterestdl3"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V3' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V3 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
