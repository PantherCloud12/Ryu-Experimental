...
module.exports = {
    name: 'mediafiredl V10',
    command: ["mf10","mediafire10"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
