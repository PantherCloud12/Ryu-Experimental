...
module.exports = {
    name: 'ttslide V28',
    command: ["ttslide28","tiktokslide28"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
