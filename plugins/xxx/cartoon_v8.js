...
module.exports = {
    name: 'cartoon V8',
    command: ["cartoon8","jadianime8"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
