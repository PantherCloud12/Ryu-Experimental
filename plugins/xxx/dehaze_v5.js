...
module.exports = {
    ...
    command: ["dehaze5"],
    category: 'hd-tools',
    description: 'Menghilangkan kabut/asap pada foto (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan dehaze V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari dehaze V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
