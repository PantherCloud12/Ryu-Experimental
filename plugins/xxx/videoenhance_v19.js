...
module.exports = {
    name: 'videoenhance V19',
    command: ["venhance19","ve19"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V19)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V19' }, { quoted: m });
        } catch (e) {
