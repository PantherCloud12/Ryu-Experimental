...
module.exports = {
    name: 'colorize V27',
    command: ["colorize27","warnai27"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
