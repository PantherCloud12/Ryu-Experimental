...
module.exports = {
    name: 'khodam V5',
    command: ["khodam5","cekkhodam5"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
