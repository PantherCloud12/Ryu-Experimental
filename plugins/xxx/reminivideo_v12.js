...
module.exports = {
    name: 'reminivideo V12',
    command: ["reminivid12","rvid12"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V12' }, { quoted: m });
        } catch (e) {
