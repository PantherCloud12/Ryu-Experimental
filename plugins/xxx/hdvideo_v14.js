...
module.exports = {
    name: 'hdvideo V14',
    command: ["hdvid14","hdvideo14","vt14"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V14' }, { quoted: m });
        } catch (e) {
