...
module.exports = {
    name: 'khodam V9',
    command: ["khodam9","cekkhodam9"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
