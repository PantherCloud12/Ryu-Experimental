...
module.exports = {
    name: 'logicai V15',
    command: ["logic15","brainlyai15"],
    category: 'ai-advanced',
    description: 'AI khusus untuk menjawab soal logika/sekolah (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan logicai V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari logicai V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
