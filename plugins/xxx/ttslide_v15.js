...
module.exports = {
    name: 'ttslide V15',
    command: ["ttslide15","tiktokslide15"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
