...
module.exports = {
    name: 'sketch V9',
    command: ["sketch9","sketsa9"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
