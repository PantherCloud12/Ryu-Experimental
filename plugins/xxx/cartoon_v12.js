...
module.exports = {
    name: 'cartoon V12',
    command: ["cartoon12","jadianime12"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
