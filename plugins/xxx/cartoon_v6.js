...
module.exports = {
    name: 'cartoon V6',
    command: ["cartoon6","jadianime6"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
