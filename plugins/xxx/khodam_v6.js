...
module.exports = {
    name: 'khodam V6',
    command: ["khodam6","cekkhodam6"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
