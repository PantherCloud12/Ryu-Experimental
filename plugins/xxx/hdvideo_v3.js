...
module.exports = {
    name: 'hdvideo V3',
    command: ["hdvid3","hdvideo3","vt3"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 3)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V3' }, { quoted: m });
        } catch (e) {
