...
module.exports = {
    name: 'logicai V4',
    command: ["logic4","brainlyai4"],
    category: 'ai-advanced',
    description: 'AI khusus untuk menjawab soal logika/sekolah (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan logicai V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari logicai V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
