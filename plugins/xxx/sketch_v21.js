...
module.exports = {
    name: 'sketch V21',
    command: ["sketch21","sketsa21"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
