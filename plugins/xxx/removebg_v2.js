...
module.exports = {
    name: 'removebg V2',
    command: ["removebg2","nobg2"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
