...
module.exports = {
    name: 'cartoon V20',
    command: ["cartoon20","jadianime20"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
