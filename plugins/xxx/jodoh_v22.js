...
module.exports = {
    name: 'jodoh V22',
    command: ["jodoh22","cekjodoh22"],
    category: 'fun-viral',
    description: 'Cek kecocokan jodoh berdasarkan nama (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan jodoh V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari jodoh V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
