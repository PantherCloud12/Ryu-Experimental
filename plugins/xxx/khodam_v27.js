...
module.exports = {
    name: 'khodam V27',
    command: ["khodam27","cekkhodam27"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
