...
module.exports = {
    name: 'reminivideo V8',
    command: ["reminivid8","rvid8"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V8' }, { quoted: m });
        } catch (e) {
