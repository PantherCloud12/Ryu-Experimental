...
module.exports = {
    name: 'colorize V7',
    command: ["colorize7","warnai7"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
