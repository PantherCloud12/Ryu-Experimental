...
module.exports = {
    name: 'blur V5',
    command: ["blur5","bokeh5"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
