...
module.exports = {
    name: 'gdrivedl V21',
    command: ["gdrive21","gd21"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
