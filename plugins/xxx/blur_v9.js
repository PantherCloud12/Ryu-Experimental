...
module.exports = {
    name: 'blur V9',
    command: ["blur9","bokeh9"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
