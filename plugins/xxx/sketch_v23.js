...
module.exports = {
    name: 'sketch V23',
    command: ["sketch23","sketsa23"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
