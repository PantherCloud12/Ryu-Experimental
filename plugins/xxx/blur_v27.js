...
module.exports = {
    name: 'blur V27',
    command: ["blur27","bokeh27"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
