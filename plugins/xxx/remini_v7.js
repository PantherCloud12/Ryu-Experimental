...
module.exports = {
    name: 'remini V7',
    command: ["remini7","hd7","upscale7"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
