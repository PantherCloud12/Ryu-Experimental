...
module.exports = {
    name: 'hdvideo V20',
    command: ["hdvid20","hdvideo20","vt20"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V20' }, { quoted: m });
        } catch (e) {
