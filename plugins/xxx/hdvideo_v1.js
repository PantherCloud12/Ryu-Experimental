...
module.exports = {
    name: 'hdvideo V1',
    command: ["hdvid","hdvideo","vt"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V1)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V1' }, { quoted: m });
        } catch (e) {
