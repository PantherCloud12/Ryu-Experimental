...
module.exports = {
    name: 'removebg V15',
    command: ["removebg15","nobg15"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
