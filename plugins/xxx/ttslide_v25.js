...
module.exports = {
    name: 'ttslide V25',
    command: ["ttslide25","tiktokslide25"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
