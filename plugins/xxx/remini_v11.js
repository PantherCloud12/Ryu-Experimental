...
module.exports = {
    name: 'remini V11',
    command: ["remini11","hd11","upscale11"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
