...
module.exports = {
    name: 'mediafiredl V23',
    command: ["mf23","mediafire23"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
