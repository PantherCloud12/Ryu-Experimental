...
module.exports = {
    name: 'khodam V12',
    command: ["khodam12","cekkhodam12"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
