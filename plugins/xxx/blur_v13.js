...
module.exports = {
    name: 'blur V13',
    command: ["blur13","bokeh13"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
