...
module.exports = {
    name: 'reminivideo V15',
    command: ["reminivid15","rvid15"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V15' }, { quoted: m });
        } catch (e) {
