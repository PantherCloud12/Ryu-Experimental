...
module.exports = {
    name: 'videoenhance V21',
    command: ["venhance21","ve21"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V21)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V21' }, { quoted: m });
        } catch (e) {
