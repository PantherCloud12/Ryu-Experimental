...
module.exports = {
    name: 'blur V30',
    command: ["blur30","bokeh30"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
