...
module.exports = {
    name: 'hdvideo V30',
    command: ["hdvid30","hdvideo30","vt30"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V30' }, { quoted: m });
        } catch (e) {
