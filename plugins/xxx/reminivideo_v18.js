...
module.exports = {
    name: 'reminivideo V18',
    command: ["reminivid18","rvid18"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V18' }, { quoted: m });
        } catch (e) {
