...
module.exports = {
    name: 'mediafiredl V29',
    command: ["mf29","mediafire29"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
