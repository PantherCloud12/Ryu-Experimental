...
module.exports = {
    name: 'ttmusic V25',
    command: ["ttmusic25","ttoaudio25"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
