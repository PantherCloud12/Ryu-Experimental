...
module.exports = {
    name: 'ttslide V26',
    command: ["ttslide26","tiktokslide26"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
