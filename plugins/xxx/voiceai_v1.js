...
module.exports = {
    name: 'voiceai V1',
    command: ["voiceai","tts-ai"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
