...
module.exports = {
    name: 'videoenhance V17',
    command: ["venhance17","ve17"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V17)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V17' }, { quoted: m });
        } catch (e) {
