...
module.exports = {
    name: 'mediafiredl V11',
    command: ["mf11","mediafire11"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
