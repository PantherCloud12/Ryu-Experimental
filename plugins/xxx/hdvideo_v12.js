...
module.exports = {
    name: 'hdvideo V12',
    command: ["hdvid12","hdvideo12","vt12"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V12' }, { quoted: m });
        } catch (e) {
