...
module.exports = {
    name: 'videoenhance V1',
    command: ["venhance","ve"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V1' }, { quoted: m });
        } catch (e) {
