...
module.exports = {
    name: 'khodam V28',
    command: ["khodam28","cekkhodam28"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
