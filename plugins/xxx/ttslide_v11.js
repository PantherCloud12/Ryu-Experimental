...
module.exports = {
    name: 'ttslide V11',
    command: ["ttslide11","tiktokslide11"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
