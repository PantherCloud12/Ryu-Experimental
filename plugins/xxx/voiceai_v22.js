...
module.exports = {
    name: 'voiceai V22',
    command: ["voiceai22","tts-ai22"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
