...
module.exports = {
    name: 'ttmusic V24',
    command: ["ttmusic24","ttoaudio24"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
