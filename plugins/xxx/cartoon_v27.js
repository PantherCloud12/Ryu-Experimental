...
module.exports = {
    name: 'cartoon V27',
    command: ["cartoon27","jadianime27"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
