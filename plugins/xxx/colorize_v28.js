...
module.exports = {
    name: 'colorize V28',
    command: ["colorize28","warnai28"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
