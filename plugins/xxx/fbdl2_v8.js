...
module.exports = {
    name: 'fbdl2 V8',
    command: ["fbdl28","fbhd8"],
    category: 'downloader-pro',
    description: 'Facebook video downloader kualitas HD (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan fbdl2 V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari fbdl2 V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
