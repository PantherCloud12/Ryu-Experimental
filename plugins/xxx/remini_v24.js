...
module.exports = {
    name: 'remini V24',
    command: ["remini24","hd24","upscale24"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
