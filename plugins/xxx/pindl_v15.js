...
module.exports = {
    name: 'pindl V15',
    command: ["pindl15","pinterestdl15"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
