...
module.exports = {
    name: 'khodam V26',
    command: ["khodam26","cekkhodam26"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
