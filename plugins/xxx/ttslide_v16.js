...
module.exports = {
    name: 'ttslide V16',
    command: ["ttslide16","tiktokslide16"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
