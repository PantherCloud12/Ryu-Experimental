...
module.exports = {
    name: 'mediafiredl V13',
    command: ["mf13","mediafire13"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
