...
module.exports = {
    name: 'removebg V5',
    command: ["removebg5","nobg5"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
