...
module.exports = {
    name: 'voiceai V28',
    command: ["voiceai28","tts-ai28"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
