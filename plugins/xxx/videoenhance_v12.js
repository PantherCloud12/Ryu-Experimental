...
module.exports = {
    name: 'videoenhance V12',
    command: ["venhance12","ve12"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V12)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V12' }, { quoted: m });
        } catch (e) {
