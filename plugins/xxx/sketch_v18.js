...
module.exports = {
    name: 'sketch V18',
    command: ["sketch18","sketsa18"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
