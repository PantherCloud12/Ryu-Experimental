...
module.exports = {
    name: 'colorize V12',
    command: ["colorize12","warnai12"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
