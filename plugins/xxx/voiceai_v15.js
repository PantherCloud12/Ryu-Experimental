...
module.exports = {
    name: 'voiceai V15',
    command: ["voiceai15","tts-ai15"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
