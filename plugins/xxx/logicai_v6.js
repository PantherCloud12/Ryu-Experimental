...
module.exports = {
    name: 'logicai V6',
    command: ["logic6","brainlyai6"],
    category: 'ai-advanced',
    description: 'AI khusus untuk menjawab soal logika/sekolah (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan logicai V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari logicai V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
