...
module.exports = {
    name: 'gdrivedl V13',
    command: ["gdrive13","gd13"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
