...
module.exports = {
    name: 'ttslide V5',
    command: ["ttslide5","tiktokslide5"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
