...
module.exports = {
    name: 'removebg V10',
    command: ["removebg10","nobg10"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
