...
module.exports = {
    name: 'ttmusic V4',
    command: ["ttmusic4","ttoaudio4"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
