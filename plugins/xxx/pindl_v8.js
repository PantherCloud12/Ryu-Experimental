...
module.exports = {
    name: 'pindl V8',
    command: ["pindl8","pinterestdl8"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
