...
module.exports = {
    name: 'voiceai V17',
    command: ["voiceai17","tts-ai17"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
