...
module.exports = {
    name: 'voiceai V12',
    command: ["voiceai12","tts-ai12"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
