...
module.exports = {
    name: 'ttmusic V21',
    command: ["ttmusic21","ttoaudio21"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
