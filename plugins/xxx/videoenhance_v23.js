...
module.exports = {
    name: 'videoenhance V23',
    command: ["venhance23","ve23"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V23)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V23' }, { quoted: m });
        } catch (e) {
