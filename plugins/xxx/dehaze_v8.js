...
module.exports = {
    ...
    command: ["dehaze8"],
    category: 'hd-tools',
    description: 'Menghilangkan kabut/asap pada foto (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan dehaze V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari dehaze V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
