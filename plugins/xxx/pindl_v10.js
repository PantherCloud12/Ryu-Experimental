...
module.exports = {
    name: 'pindl V10',
    command: ["pindl10","pinterestdl10"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
