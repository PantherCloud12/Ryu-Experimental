...
module.exports = {
    name: 'remini V23',
    command: ["remini23","hd23","upscale23"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
