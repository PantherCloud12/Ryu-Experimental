...
module.exports = {
    name: 'khodam V4',
    command: ["khodam4","cekkhodam4"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
