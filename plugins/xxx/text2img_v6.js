...
module.exports = {
    name: 'text2img V6',
    command: ["text2img6","aiimg6"],
    category: 'ai-advanced',
    description: 'Buat gambar dari teks (AI Art) (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan text2img V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari text2img V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
