...
module.exports = {
    name: 'videoenhance V16',
    command: ["venhance16","ve16"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V16' }, { quoted: m });
        } catch (e) {
