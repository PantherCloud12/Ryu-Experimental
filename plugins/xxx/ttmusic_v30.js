...
module.exports = {
    name: 'ttmusic V30',
    command: ["ttmusic30","ttoaudio30"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
