...
module.exports = {
    name: 'removebg V9',
    command: ["removebg9","nobg9"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
