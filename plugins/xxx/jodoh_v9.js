...
module.exports = {
    name: 'jodoh V9',
    command: ["jodoh9","cekjodoh9"],
    category: 'fun-viral',
    description: 'Cek kecocokan jodoh berdasarkan nama (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan jodoh V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari jodoh V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
