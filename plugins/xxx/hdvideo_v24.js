...
module.exports = {
    name: 'hdvideo V24',
    command: ["hdvid24","hdvideo24","vt24"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V24' }, { quoted: m });
        } catch (e) {
