...
module.exports = {
    name: 'khodam V25',
    command: ["khodam25","cekkhodam25"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
