...
module.exports = {
    name: 'hdvideo V21',
    command: ["hdvid21","hdvideo21","vt21"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V21' }, { quoted: m });
        } catch (e) {
