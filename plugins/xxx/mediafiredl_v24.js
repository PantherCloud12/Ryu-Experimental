...
module.exports = {
    name: 'mediafiredl V24',
    command: ["mf24","mediafire24"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
