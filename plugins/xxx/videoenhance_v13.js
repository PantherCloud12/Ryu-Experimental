...
module.exports = {
    name: 'videoenhance V13',
    command: ["venhance13","ve13"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V13)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V13' }, { quoted: m });
        } catch (e) {
