...
module.exports = {
    name: 'pindl V25',
    command: ["pindl25","pinterestdl25"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
