...
module.exports = {
    name: 'hdvideo V29',
    command: ["hdvid29","hdvideo29","vt29"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V29' }, { quoted: m });
        } catch (e) {
