...
module.exports = {
    name: 'pindl V17',
    command: ["pindl17","pinterestdl17"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
