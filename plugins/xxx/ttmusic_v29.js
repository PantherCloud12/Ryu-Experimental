...
module.exports = {
    name: 'ttmusic V29',
    command: ["ttmusic29","ttoaudio29"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
