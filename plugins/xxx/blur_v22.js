...
module.exports = {
    name: 'blur V22',
    command: ["blur22","bokeh22"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
