...
module.exports = {
    name: 'remini V30',
    command: ["remini30","hd30","upscale30"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
