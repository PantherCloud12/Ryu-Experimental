...
module.exports = {
    name: 'sketch V30',
    command: ["sketch30","sketsa30"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
