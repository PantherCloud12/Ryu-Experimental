...
module.exports = {
    name: 'ttslide V13',
    command: ["ttslide13","tiktokslide13"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
