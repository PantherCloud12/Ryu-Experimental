...
module.exports = {
    name: 'hdvideo V26',
    command: ["hdvid26","hdvideo26","vt26"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V26' }, { quoted: m });
        } catch (e) {
