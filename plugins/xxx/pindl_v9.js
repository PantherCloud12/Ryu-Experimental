...
module.exports = {
    name: 'pindl V9',
    command: ["pindl9","pinterestdl9"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
