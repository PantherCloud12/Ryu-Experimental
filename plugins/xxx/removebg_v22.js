...
module.exports = {
    name: 'removebg V22',
    command: ["removebg22","nobg22"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
