...
module.exports = {
    name: 'mediafiredl V15',
    command: ["mf15","mediafire15"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
