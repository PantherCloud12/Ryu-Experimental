...
module.exports = {
    name: 'mediafiredl V26',
    command: ["mf26","mediafire26"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
