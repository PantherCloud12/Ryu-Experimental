...
module.exports = {
    name: 'ttmusic V5',
    command: ["ttmusic5","ttoaudio5"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
