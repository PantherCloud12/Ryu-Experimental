...
module.exports = {
    name: 'ttslide V12',
    command: ["ttslide12","tiktokslide12"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
