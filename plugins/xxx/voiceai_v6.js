...
module.exports = {
    name: 'voiceai V6',
    command: ["voiceai6","tts-ai6"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
