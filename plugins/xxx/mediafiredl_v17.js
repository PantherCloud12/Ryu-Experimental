...
module.exports = {
    name: 'mediafiredl V17',
    command: ["mf17","mediafire17"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
