...
module.exports = {
    name: 'removebg V17',
    command: ["removebg17","nobg17"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
