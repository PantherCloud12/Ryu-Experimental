...
module.exports = {
    name: 'blur V20',
    command: ["blur20","bokeh20"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
