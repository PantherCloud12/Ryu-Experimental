...
module.exports = {
    name: 'fbdl2 V14',
    command: ["fbdl214","fbhd14"],
    category: 'downloader-pro',
    description: 'Facebook video downloader kualitas HD (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan fbdl2 V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari fbdl2 V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
