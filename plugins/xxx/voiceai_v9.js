...
module.exports = {
    name: 'voiceai V9',
    command: ["voiceai9","tts-ai9"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
