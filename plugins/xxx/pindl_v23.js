...
module.exports = {
    name: 'pindl V23',
    command: ["pindl23","pinterestdl23"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
