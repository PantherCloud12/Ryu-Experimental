...
module.exports = {
    name: 'hdvideo V22',
    command: ["hdvid22","hdvideo22","vt22"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V22' }, { quoted: m });
        } catch (e) {
