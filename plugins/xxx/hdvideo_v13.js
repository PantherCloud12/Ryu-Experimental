...
module.exports = {
    name: 'hdvideo V13',
    command: ["hdvid13","hdvideo13","vt13"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V13' }, { quoted: m });
        } catch (e) {
