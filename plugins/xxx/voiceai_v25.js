...
module.exports = {
    name: 'voiceai V25',
    command: ["voiceai25","tts-ai25"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
