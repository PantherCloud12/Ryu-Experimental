...
module.exports = {
    name: 'voiceai V27',
    command: ["voiceai27","tts-ai27"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
