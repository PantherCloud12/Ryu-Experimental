...
module.exports = {
    name: 'voiceai V4',
    command: ["voiceai4","tts-ai4"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
