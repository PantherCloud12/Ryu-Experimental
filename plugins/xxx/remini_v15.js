...
module.exports = {
    name: 'remini V15',
    command: ["remini15","hd15","upscale15"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
