...
module.exports = {
    name: 'text2img V9',
    command: ["text2img9","aiimg9"],
    category: 'ai-advanced',
    description: 'Buat gambar dari teks (AI Art) (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan text2img V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari text2img V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
