...
module.exports = {
    name: 'blur V16',
    command: ["blur16","bokeh16"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
