...
module.exports = {
    name: 'removebg V21',
    command: ["removebg21","nobg21"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
