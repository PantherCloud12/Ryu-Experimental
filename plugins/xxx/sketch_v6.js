...
module.exports = {
    name: 'sketch V6',
    command: ["sketch6","sketsa6"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
