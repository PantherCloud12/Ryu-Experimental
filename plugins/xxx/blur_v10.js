...
module.exports = {
    name: 'blur V10',
    command: ["blur10","bokeh10"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
