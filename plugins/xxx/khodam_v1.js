...
module.exports = {
    name: 'khodam V1',
    command: ["khodam","cekkhodam"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
