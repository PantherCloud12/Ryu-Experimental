...
module.exports = {
    name: 'blur V12',
    command: ["blur12","bokeh12"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
