...
module.exports = {
    name: 'blur V11',
    command: ["blur11","bokeh11"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
