...
module.exports = {
    name: 'reminivideo V13',
    command: ["reminivid13","rvid13"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V13' }, { quoted: m });
        } catch (e) {
