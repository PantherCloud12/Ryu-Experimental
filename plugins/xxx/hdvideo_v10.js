...
module.exports = {
    name: 'hdvideo V10',
    command: ["hdvid10","hdvideo10","vt10"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V10' }, { quoted: m });
        } catch (e) {
