...
module.exports = {
    name: 'gdrivedl V11',
    command: ["gdrive11","gd11"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
