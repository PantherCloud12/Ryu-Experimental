...
module.exports = {
    name: 'khodam V22',
    command: ["khodam22","cekkhodam22"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
