...
module.exports = {
    name: 'remini V28',
    command: ["remini28","hd28","upscale28"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
