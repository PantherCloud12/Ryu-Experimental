...
module.exports = {
    name: 'videoenhance V25',
    command: ["venhance25","ve25"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V25)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V25' }, { quoted: m });
        } catch (e) {
