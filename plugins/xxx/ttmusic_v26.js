...
module.exports = {
    name: 'ttmusic V26',
    command: ["ttmusic26","ttoaudio26"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
