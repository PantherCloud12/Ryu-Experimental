...
module.exports = {
    name: 'gdrivedl V14',
    command: ["gdrive14","gd14"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
