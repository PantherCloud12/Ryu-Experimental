...
module.exports = {
    name: 'blur V14',
    command: ["blur14","bokeh14"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
