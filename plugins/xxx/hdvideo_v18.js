...
module.exports = {
    name: 'hdvideo V18',
    command: ["hdvid18","hdvideo18","vt18"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V18' }, { quoted: m });
        } catch (e) {
