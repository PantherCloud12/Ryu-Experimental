...
module.exports = {
    name: 'removebg V25',
    command: ["removebg25","nobg25"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
