...
module.exports = {
    name: 'ttslide V19',
    command: ["ttslide19","tiktokslide19"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
