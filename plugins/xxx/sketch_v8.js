...
module.exports = {
    name: 'sketch V8',
    command: ["sketch8","sketsa8"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
