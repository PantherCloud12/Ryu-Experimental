...
module.exports = {
    name: 'cartoon V30',
    command: ["cartoon30","jadianime30"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
