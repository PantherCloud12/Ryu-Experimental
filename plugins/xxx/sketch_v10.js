...
module.exports = {
    name: 'sketch V10',
    command: ["sketch10","sketsa10"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
