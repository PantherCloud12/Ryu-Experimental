...
module.exports = {
    name: 'sketch V20',
    command: ["sketch20","sketsa20"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
