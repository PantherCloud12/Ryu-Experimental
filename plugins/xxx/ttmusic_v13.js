...
module.exports = {
    name: 'ttmusic V13',
    command: ["ttmusic13","ttoaudio13"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 13)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V13' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V13 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
