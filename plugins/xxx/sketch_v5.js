...
module.exports = {
    name: 'sketch V5',
    command: ["sketch5","sketsa5"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V5' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V5 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
