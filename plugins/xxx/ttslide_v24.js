...
module.exports = {
    name: 'ttslide V24',
    command: ["ttslide24","tiktokslide24"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
