...
module.exports = {
    name: 'khodam V8',
    command: ["khodam8","cekkhodam8"],
    category: 'fun-viral',
    description: 'Cek khodam penunggu namamu (Viral) (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('fun-viral')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan khodam V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari khodam V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
