...
module.exports = {
    name: 'gdrivedl V23',
    command: ["gdrive23","gd23"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
