...
module.exports = {
    name: 'cartoon V18',
    command: ["cartoon18","jadianime18"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
