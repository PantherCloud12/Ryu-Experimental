...
module.exports = {
    name: 'hdvideo V16',
    command: ["hdvid16","hdvideo16","vt16"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V16' }, { quoted: m });
        } catch (e) {
