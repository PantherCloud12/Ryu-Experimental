...
module.exports = {
    name: 'removebg V26',
    command: ["removebg26","nobg26"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
