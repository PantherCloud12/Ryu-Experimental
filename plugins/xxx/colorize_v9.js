...
module.exports = {
    name: 'colorize V9',
    command: ["colorize9","warnai9"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V9' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V9 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
