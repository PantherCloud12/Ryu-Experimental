...
module.exports = {
    name: 'gdrivedl V12',
    command: ["gdrive12","gd12"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 12)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V12' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V12 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
