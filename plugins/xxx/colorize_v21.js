...
module.exports = {
    name: 'colorize V21',
    command: ["colorize21","warnai21"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
