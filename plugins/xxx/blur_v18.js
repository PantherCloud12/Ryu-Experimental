...
module.exports = {
    name: 'blur V18',
    command: ["blur18","bokeh18"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
