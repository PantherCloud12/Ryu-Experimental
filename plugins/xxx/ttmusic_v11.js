...
module.exports = {
    name: 'ttmusic V11',
    command: ["ttmusic11","ttoaudio11"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
