...
module.exports = {
    name: 'ttslide V17',
    command: ["ttslide17","tiktokslide17"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V17' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V17 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
