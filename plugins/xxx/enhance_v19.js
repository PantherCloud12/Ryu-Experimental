...
module.exports = {
    ...
    command: ["enhance19"],
    category: 'hd-tools',
    description: 'Auto enhance kualitas gambar (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan enhance V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari enhance V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
