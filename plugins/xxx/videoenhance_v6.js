...
module.exports = {
    name: 'videoenhance V6',
    command: ["venhance6","ve6"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V6)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V6' }, { quoted: m });
        } catch (e) {
