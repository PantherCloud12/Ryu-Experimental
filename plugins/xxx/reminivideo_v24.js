...
module.exports = {
    name: 'reminivideo V24',
    command: ["reminivid24","rvid24"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V24' }, { quoted: m });
        } catch (e) {
