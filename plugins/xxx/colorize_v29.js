...
module.exports = {
    name: 'colorize V29',
    command: ["colorize29","warnai29"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 29)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V29' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V29 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
