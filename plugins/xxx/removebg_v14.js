...
module.exports = {
    name: 'removebg V14',
    command: ["removebg14","nobg14"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
