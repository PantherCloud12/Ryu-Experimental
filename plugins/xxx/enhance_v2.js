...
module.exports = {
    ...
    command: ["enhance2"],
    category: 'hd-tools',
    description: 'Auto enhance kualitas gambar (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan enhance V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari enhance V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
