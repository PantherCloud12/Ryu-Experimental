...
module.exports = {
    name: 'voiceai V11',
    command: ["voiceai11","tts-ai11"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
