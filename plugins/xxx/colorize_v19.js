...
module.exports = {
    name: 'colorize V19',
    command: ["colorize19","warnai19"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
