...
module.exports = {
    name: 'videoenhance V8',
    command: ["venhance8","ve8"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V8)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V8' }, { quoted: m });
        } catch (e) {
