...
module.exports = {
    name: 'sketch V24',
    command: ["sketch24","sketsa24"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
