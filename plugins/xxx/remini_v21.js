...
module.exports = {
    name: 'remini V21',
    command: ["remini21","hd21","upscale21"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
