...
module.exports = {
    name: 'colorize V1',
    command: ["colorize","warnai"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 1)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V1' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V1 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
