...
module.exports = {
    name: 'blur V28',
    command: ["blur28","bokeh28"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 28)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V28' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V28 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
