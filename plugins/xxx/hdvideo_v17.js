...
module.exports = {
    name: 'hdvideo V17',
    command: ["hdvid17","hdvideo17","vt17"],
    category: 'video-tools',
    description: 'Meningkatkan kualitas video menjadi HD (Versi 17)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan hdvideo V17' }, { quoted: m });
        } catch (e) {
