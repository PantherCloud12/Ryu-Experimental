...
module.exports = {
    name: 'reminivideo V30',
    command: ["reminivid30","rvid30"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V30' }, { quoted: m });
        } catch (e) {
