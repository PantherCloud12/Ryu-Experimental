...
module.exports = {
    name: 'blur V25',
    command: ["blur25","bokeh25"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 25)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V25' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V25 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
