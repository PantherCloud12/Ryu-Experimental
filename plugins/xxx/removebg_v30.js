...
module.exports = {
    name: 'removebg V30',
    command: ["removebg30","nobg30"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
