...
module.exports = {
    name: 'pindl V30',
    command: ["pindl30","pinterestdl30"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 30)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V30' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V30 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
