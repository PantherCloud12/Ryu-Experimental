...
module.exports = {
    name: 'cartoon V24',
    command: ["cartoon24","jadianime24"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi kartun/anime (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan cartoon V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari cartoon V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
