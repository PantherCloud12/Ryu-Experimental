...
module.exports = {
    name: 'removebg V6',
    command: ["removebg6","nobg6"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
