...
module.exports = {
    name: 'mediafiredl V21',
    command: ["mf21","mediafire21"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
