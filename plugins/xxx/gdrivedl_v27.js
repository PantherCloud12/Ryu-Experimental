...
module.exports = {
    name: 'gdrivedl V27',
    command: ["gdrive27","gd27"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
