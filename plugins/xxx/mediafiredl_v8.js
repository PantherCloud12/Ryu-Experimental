...
module.exports = {
    name: 'mediafiredl V8',
    command: ["mf8","mediafire8"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
