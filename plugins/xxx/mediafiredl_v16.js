...
module.exports = {
    name: 'mediafiredl V16',
    command: ["mf16","mediafire16"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
