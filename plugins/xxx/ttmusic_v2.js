...
module.exports = {
    name: 'ttmusic V2',
    command: ["ttmusic2","ttoaudio2"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
