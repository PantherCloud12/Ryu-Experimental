...
module.exports = {
    name: 'reminivideo V4',
    command: ["reminivid4","rvid4"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V4' }, { quoted: m });
        } catch (e) {
