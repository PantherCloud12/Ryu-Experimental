...
module.exports = {
    name: 'ttslide V4',
    command: ["ttslide4","tiktokslide4"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
