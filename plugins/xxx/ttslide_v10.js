...
module.exports = {
    name: 'ttslide V10',
    command: ["ttslide10","tiktokslide10"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 10)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V10' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V10 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
