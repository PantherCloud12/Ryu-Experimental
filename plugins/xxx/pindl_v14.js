...
module.exports = {
    name: 'pindl V14',
    command: ["pindl14","pinterestdl14"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
