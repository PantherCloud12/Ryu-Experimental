...
module.exports = {
    name: 'ttmusic V20',
    command: ["ttmusic20","ttoaudio20"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
