...
module.exports = {
    name: 'videoenhance V5',
    command: ["venhance5","ve5"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 5)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V5)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V5' }, { quoted: m });
        } catch (e) {
