...
module.exports = {
    name: 'videoenhance V18',
    command: ["venhance18","ve18"],
    category: 'video-tools',
    description: 'Auto enhance kualitas video (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔄 *Sedang memproses video ke HD... Mohon tunggu (V18)*' }, { quoted: m });
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan videoenhance V18' }, { quoted: m });
        } catch (e) {
