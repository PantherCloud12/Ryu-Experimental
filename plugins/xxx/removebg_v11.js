...
module.exports = {
    name: 'removebg V11',
    command: ["removebg11","nobg11"],
    category: 'hd-tools',
    description: 'Menghapus background foto otomatis (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan removebg V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari removebg V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
