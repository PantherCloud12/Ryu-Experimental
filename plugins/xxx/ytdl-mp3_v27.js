...
module.exports = {
    name: 'ytdl-mp3 V27',
    command: ["ytmp327","yta27"],
    category: 'downloader-pro',
    description: 'Download audio YouTube tercepat (Versi 27)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ytdl-mp3 V27' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ytdl-mp3 V27 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
