...
module.exports = {
    name: 'ttslide V23',
    command: ["ttslide23","tiktokslide23"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
