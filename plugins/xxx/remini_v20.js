...
module.exports = {
    name: 'remini V20',
    command: ["remini20","hd20","upscale20"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
