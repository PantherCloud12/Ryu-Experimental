...
module.exports = {
    name: 'blur V6',
    command: ["blur6","bokeh6"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 6)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V6' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V6 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
