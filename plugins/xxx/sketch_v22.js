...
module.exports = {
    name: 'sketch V22',
    command: ["sketch22","sketsa22"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
