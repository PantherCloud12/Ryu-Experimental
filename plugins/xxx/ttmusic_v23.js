...
module.exports = {
    name: 'ttmusic V23',
    command: ["ttmusic23","ttoaudio23"],
    category: 'downloader-pro',
    description: 'Download audio/mp3 dari TikTok (Versi 23)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttmusic V23' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttmusic V23 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
