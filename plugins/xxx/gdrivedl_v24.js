...
module.exports = {
    name: 'gdrivedl V24',
    command: ["gdrive24","gd24"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
