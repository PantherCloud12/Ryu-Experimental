...
module.exports = {
    name: 'sketch V15',
    command: ["sketch15","sketsa15"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 15)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V15' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V15 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
