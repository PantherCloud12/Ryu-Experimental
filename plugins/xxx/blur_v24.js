...
module.exports = {
    name: 'blur V24',
    command: ["blur24","bokeh24"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 24)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V24' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V24 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
