...
module.exports = {
    name: 'remini V22',
    command: ["remini22","hd22","upscale22"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
