...
module.exports = {
    name: 'pindl V22',
    command: ["pindl22","pinterestdl22"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 22)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V22' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V22 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
