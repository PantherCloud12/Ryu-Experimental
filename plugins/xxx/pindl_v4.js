...
module.exports = {
    name: 'pindl V4',
    command: ["pindl4","pinterestdl4"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
