...
module.exports = {
    name: 'blur V19',
    command: ["blur19","bokeh19"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
