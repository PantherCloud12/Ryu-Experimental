...
module.exports = {
    name: 'pindl V11',
    command: ["pindl11","pinterestdl11"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 11)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V11' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V11 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
