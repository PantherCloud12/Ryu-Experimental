...
module.exports = {
    name: 'voiceai V16',
    command: ["voiceai16","tts-ai16"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 16)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V16' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V16 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
