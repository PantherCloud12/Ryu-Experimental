...
module.exports = {
    name: 'gdrivedl V20',
    command: ["gdrive20","gd20"],
    category: 'downloader-pro',
    description: 'Auto download file dari Google Drive (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan gdrivedl V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari gdrivedl V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
