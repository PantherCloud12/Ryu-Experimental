...
module.exports = {
    name: 'ttslide V18',
    command: ["ttslide18","tiktokslide18"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
