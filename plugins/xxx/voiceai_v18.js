...
module.exports = {
    name: 'voiceai V18',
    command: ["voiceai18","tts-ai18"],
    category: 'ai-advanced',
    description: 'Ubah teks jadi suara berbagai karakter (Versi 18)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('ai-advanced')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan voiceai V18' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari voiceai V18 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
