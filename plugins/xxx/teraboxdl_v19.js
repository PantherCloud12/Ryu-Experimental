...
module.exports = {
    ...
    description: 'Download file dari Terabox (Versi 19)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan teraboxdl V19' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari teraboxdl V19 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
