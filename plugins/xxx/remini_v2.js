...
module.exports = {
    name: 'remini V2',
    command: ["remini2","hd2","upscale2"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 2)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V2' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V2 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
