...
module.exports = {
    name: 'ttslide V14',
    command: ["ttslide14","tiktokslide14"],
    category: 'downloader-pro',
    description: 'Download foto slide TikTok tanpa WM (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan ttslide V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari ttslide V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
