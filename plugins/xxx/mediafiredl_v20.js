...
module.exports = {
    name: 'mediafiredl V20',
    command: ["mf20","mediafire20"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 20)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V20' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V20 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
