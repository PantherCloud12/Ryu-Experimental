...
module.exports = {
    name: 'blur V4',
    command: ["blur4","bokeh4"],
    category: 'hd-tools',
    description: 'Memberikan efek blur/bokeh pada foto (Versi 4)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan blur V4' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari blur V4 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
