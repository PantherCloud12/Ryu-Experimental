...
module.exports = {
    name: 'reminivideo V9',
    command: ["reminivid9","rvid9"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 9)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V9' }, { quoted: m });
        } catch (e) {
