...
module.exports = {
    name: 'remini V8',
    command: ["remini8","hd8","upscale8"],
    category: 'hd-tools',
    description: 'Meningkatkan kualitas foto menjadi HD (Versi 8)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan remini V8' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari remini V8 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
