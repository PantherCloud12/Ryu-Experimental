...
module.exports = {
    name: 'pindl V21',
    command: ["pindl21","pinterestdl21"],
    category: 'downloader-pro',
    description: 'Download video/foto dari Pinterest (Versi 21)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan pindl V21' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari pindl V21 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
