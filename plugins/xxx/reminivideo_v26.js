...
module.exports = {
    name: 'reminivideo V26',
    command: ["reminivid26","rvid26"],
    category: 'video-tools',
    description: 'Remini khusus untuk video (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { video: buffer, caption: '✅ Video berhasil diubah ke HD menggunakan reminivideo V26' }, { quoted: m });
        } catch (e) {
