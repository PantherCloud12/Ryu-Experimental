...
module.exports = {
    name: 'mediafiredl V7',
    command: ["mf7","mediafire7"],
    category: 'downloader-pro',
    description: 'Auto download file dari Mediafire (Versi 7)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('downloader-pro')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan mediafiredl V7' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari mediafiredl V7 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
