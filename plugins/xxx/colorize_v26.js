...
module.exports = {
    name: 'colorize V26',
    command: ["colorize26","warnai26"],
    category: 'hd-tools',
    description: 'Mewarnai foto hitam putih otomatis (Versi 26)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan colorize V26' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari colorize V26 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
