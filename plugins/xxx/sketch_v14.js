...
module.exports = {
    name: 'sketch V14',
    command: ["sketch14","sketsa14"],
    category: 'hd-tools',
    description: 'Mengubah foto menjadi sketsa pensil (Versi 14)',
    execute: async (sock, m, { text, config, quotedMsg }) => {
        ...
        try {
            if (['hd-tools'].includes('hd-tools')) {
                ...
                await sock.sendMessage(from, { image: buffer, caption: '✅ Berhasil diproses dengan sketch V14' }, { quoted: m });
                ...
                await sock.sendMessage(from, { text: '✅ Hasil: Ini adalah jawaban dari sketch V14 menggunakan ' + baseUrl }, { quoted: m });
            }
        } catch (e) {
