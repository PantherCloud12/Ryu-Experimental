...
module.exports = {
    ...
    category: 'downloader',
    description: 'Mengunduh video/foto dari Instagram Post/Reels/Story',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const res = await axios.get(`https://api.agatz.xyz/api/download/igdl?url=${encodeURIComponent(text)}`);
