...
module.exports = {
    ...
    category: 'search',
    description: 'Mencari chord kunci gitar lagu',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const res = await axios.get(`https://api.agatz.xyz/api/chord?query=${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🔍 *HASIL PENCARIAN CHORD*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
