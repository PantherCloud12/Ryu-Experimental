...
module.exports = {
    ...
    category: 'search',
    description: 'Mencari resep masakan Nusantara',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const res = await axios.get(`https://api.agatz.xyz/api/resep?query=${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🔍 *HASIL PENCARIAN RECIPE*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
