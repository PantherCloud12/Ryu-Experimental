...
module.exports = {
    ...
    command: ["kamus"],
    category: 'search',
    description: 'Mencari definisi kata di Kamus Besar Bahasa Indonesia (KBBI)',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const res = await axios.get(`https://api.agatz.xyz/api/kbbi?kata=${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🔍 *HASIL PENCARIAN KBBI*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
