...
module.exports = {
    ...
    command: ["ddg"],
    category: 'search',
    description: 'Mencari informasi secara privat dengan DuckDuckGo',
    isGroup: false,
    isAdmin: false,
    isBotAdmin: false,
    execute: async (sock, m, { text, args, isGroup, sender, groupMetadata, config, dbHelper, quotedMsg }) => {
        ...
        try {
            ...
            const res = await axios.get(`https://api.agatz.xyz/api/google?query=${encodeURIComponent(text)}`);
            ...
            await sock.sendMessage(from, { text: `🔍 *HASIL PENCARIAN DUCKDUCKGO*\n\n${replyText}` }, { quoted: m });
        } catch (err) {
